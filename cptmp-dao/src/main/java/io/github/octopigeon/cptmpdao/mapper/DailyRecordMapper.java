...
public interface DailyRecordMapper {
    ...
    void updateDailyRecordById(DailyRecord dailyRecord);
    ...
    void updateDailyRecordByUserId(DailyRecord dailyRecord);
    ...
    void updateDailyRecordByTeamId( DailyRecord dailyRecord);
